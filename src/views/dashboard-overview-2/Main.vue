          ...
          <div class="grid grid-cols-12 gap-6 mt-5">
            <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
              <div class="report-box zoom-in">
                <div class="box p-5">
                  <div class="flex">
                    <ShoppingCartIcon class="report-box__icon text-theme-21" />
                    <div class="ml-auto">
                      <Tippy
                        tag="div"
            ...
            <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
              <div class="report-box zoom-in">
                <div class="box p-5">
                  <div class="flex">
                    <CreditCardIcon class="report-box__icon text-theme-22" />
                    <div class="ml-auto">
                      <Tippy
                        tag="div"
                        class="report-box__indicator bg-theme-24 cursor-pointer"
            ...
            <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
              <div class="report-box zoom-in">
                <div class="box p-5">
                  <div class="flex">
                    <MonitorIcon class="report-box__icon text-theme-23" />
                    <div class="ml-auto">
                      <Tippy
                        tag="div"
                        class="report-box__indicator bg-theme-10 cursor-pointer"
          ...
          <div class="intro-y box p-5 mt-12 sm:mt-5">
            <div class="flex flex-col xl:flex-row xl:items-center">
              <div class="flex">
                <div>
                  <div
                    class="text-theme-26 dark:text-gray-300 text-lg xl:text-xl font-medium"
                  >
                    $15,000
                  </div>
        ...
        <div class="xxl:pl-6 grid grid-cols-12 gap-6">
          ...
          >
            ...
            <div class="mt-5">
              ...
              <a
                href=""
                class="intro-x w-full block text-center rounded-md py-3 border border-dotted border-theme-28 dark:border-dark-5 text-theme-600 dark:text-gray-600"
                >View More</a
              >
            </div>
          </div>
          ...
          >
            <div class="intro-x flex items-center h-10">
              ...
              <a
                href=""
                class="ml-auto text-theme-26 dark:text-theme-33 truncate flex items-center"
              >
              ...
              <div class="intro-x box">
                <div class="p-5">
                  ...
                  <div class="grid grid-cols-7 gap-4 mt-5 text-center">
                    ...
                    <div
                      class="py-0.5 bg-theme-30 dark:bg-theme-11 rounded relative"
                    >
                      23
                    </div>
                    ...
                    <div
                      class="py-0.5 bg-theme-31 dark:bg-theme-12 rounded relative"
                    >
                      27
                    </div>
